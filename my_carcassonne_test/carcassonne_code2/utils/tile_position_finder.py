...
from carcassonne_code2.utils.tile_fitter import TileFitter
...
class TilePositionFinder:
    ...
    @staticmethod
    def check_tile_actions(game_state: CarcassonneGameState, tile_to_play: Tile, row_index: int, column_index: int, tile_turns: int) -> bool:
        if game_state.get_tile(row_index, column_index) is not None:
            return False
